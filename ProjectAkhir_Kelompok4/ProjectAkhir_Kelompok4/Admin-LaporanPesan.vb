...
Public Class Admin_LaporanPesan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProjectAkhir_Kelompok4.Admin-LaporanPesan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAdmin_LaporanPesan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Admin_LaporanPesan = New Admin_LaporanPesan()
        rpt.Site = Me.Site
        Return rpt
    End Function
